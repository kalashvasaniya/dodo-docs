...
|---------|------------|-------------------------------------------------------------------------------------------------|--------------------------|
| `v1.56.0` | `27-10-2025` | Streamlined onboarding, C# SDK launch, webhook verification, Two-Factor Authentication, overlay checkout sessions, and usage-based subscription plan changes | [Link](/changelog/v1.56.0)|
