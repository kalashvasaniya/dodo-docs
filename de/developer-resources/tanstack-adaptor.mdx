...
description: Erfahren Sie, wie Sie Dodo Payments in Ihr Tanstack App
  Router-Projekt integrieren, indem Sie unseren Tanstack Adaptor verwenden.
...
Der Customer Portal Route Handler ermöglicht es Ihnen, das Dodo Payments Kundenportal nahtlos in Ihre Tanstack-Anwendung zu integrieren.
