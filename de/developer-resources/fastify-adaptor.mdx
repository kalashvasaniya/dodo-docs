...
description: Erfahren Sie, wie Sie Dodo Payments in Ihr Fastify App
  Router-Projekt mit unserem NextJS Adaptor integrieren. Behandelt Checkout,
...
Checkout-Sitzungen bieten ein sichereres, gehostetes Checkout-Erlebnis, das den vollständigen Zahlungsfluss sowohl für einmalige Käufe als auch für Abonnements mit vollständiger Anpassungskontrolle behandelt.

Siehe [Leitfaden zur Integration von Checkout-Sitzungen](https://docs.dodopayments.com/developer-resources/checkout-session) für weitere Details und eine vollständige Liste der unterstützten Felder.
...
Der Customer Portal Route Handler ermöglicht es Ihnen, das Dodo Payments Kundenportal nahtlos in Ihre Fastify-Anwendung zu integrieren.
...
Der @dodopayments/fastify-Adapter bietet Routenhandler für die Checkout-, Kundenportal- und Webhook-Funktionalitäten von Dodo Payments, die direkt in eine Fastify-App integriert werden können.
...
Konfigurationsoptionen:
    ...
    bearerToken: Ihr Dodo Payments API-Schlüssel (empfohlen, in der Umgebungsvariable DODO_PAYMENTS_API_KEY zu speichern).
...
POST (Checkout-Sitzungen) - (Empfohlen) Ein anpassbareres Checkout-Erlebnis. Gibt JSON mit checkout_url zurück: Parameter werden als JSON-Body gesendet. Unterstützt sowohl einmalige als auch wiederkehrende Zahlungen. Gibt zurück: {"checkout_url": "https://checkout.dodopayments.com/session/..."}. Für eine vollständige Liste der unterstützten Felder siehe:
    ...
    Leitfaden zur Integration von Checkout-Sitzungen: https://docs.dodopayments.com/developer-resources/checkout-session
